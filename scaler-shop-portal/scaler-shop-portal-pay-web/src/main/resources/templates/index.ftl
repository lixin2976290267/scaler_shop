...
<div class="head">
    <div class="head-center">
        ...
        <div class="head-center-user">用户名：1844639501@qq.com</div>
    </div>
    ...
    <div class="footer">Copyright © 2016 - 2018 scaler. All Rights
        Reserved SCALER 版权所有
    </div>
</div>
</body>
...
<script type="text/javascript">
    ...
    if (isMobile) {
        ...
        console.log("SCALER PC手机版本充值...")
    } else {
        console.log("SCALER PC电脑版本充值...")
    }
