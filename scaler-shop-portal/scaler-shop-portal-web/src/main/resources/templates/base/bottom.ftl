	...
	<div class="layui-container">
		...
		<div class="about">
			<span class="layui-breadcrumb" lay-separator="|"> <a
				href="http://www.baidu.com" target="_blank">关于我们</a> <a
				href="http://www.baidu.com" target="_blank">帮助中心</a> <a
				href="http://www.baidu.com" target="_blank">售后服务</a> <a
				href="http://www.baidu.com" target="_blank">配送服务</a> <a
				href="http://www.baidu.com" target="_blank">关于货源</a>
			</span>
			<p>Scaler版权所有- &copy; 2018-2019</p>
		</div>
	</div>
</div>
